...
import BrowserDemo from "../../components/BrowserDemo.astro"
...
If you want to try OpenTUI before installing anything, start with the browser workbench below. It runs the Zig renderer as WebAssembly through `@opentui/core/browser`, so the docs can show a real interactive OpenTUI surface directly in your browser.
