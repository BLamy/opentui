...
const menu = new SelectRenderable(renderer, {
  ...
  options: [
    { name: "New File", description: "Create a new file" },
    { name: "Open File", description: "Browse an existing file" },
    { name: "Save", description: "Write the current buffer to disk" },
...
const menu = new SelectRenderable(renderer, {
  ...
  height: 8,
  options: [
    { name: "Preview", description: "Inspect the current selection" },
    { name: "Rename", description: "Update the item label" },
    { name: "Share", description: "Send the item to a teammate" },
  ],
})
...
```ts example
import { SelectRenderable, createCliRenderer } from "@opentui/core"
...
const styledMenu = new SelectRenderable(renderer, {
  ...
  height: 10,
  options: [
    { name: "Dashboard", description: "Open the main overview" },
    { name: "Reports", description: "View generated reports" },
    { name: "Settings", description: "Adjust application preferences" },
  ],
...
const menu = Select({
  ...
  height: 8,
  options: [
    { name: "Overview", description: "Show the home dashboard" },
    { name: "Issues", description: "Open the issue queue" },
    { name: "Deployments", description: "Review recent deploys" },
  ],
})

const currentIndex = menu.getSelectedIndex()
console.log("Current selection:", currentIndex)
